...
2. **Infer Template Variables**:
   ...
   | ------------------------- | ---------------------------------------------------------------------- |
   | `napx-pms`        | Config file name field or directory name                               |
   | `End to End Workforce Accommodation Platform for Professional Workforces and Short Stay Property Operators` | Config file description or README                                      |
   | `TypeScript`            | Detected language                                                      |
   | `NestJS + Next.js`           | Detected framework                                                     |
   | `pnpm`     | Lock file or config                                                    |
   | `3000`            | Scripts, config, or framework default                                  |
   | `PostgreSQL (Amazon RDS)`            | ORM/database dependencies                                              |
   | `Jest`      | Test framework                                                         |
   | `AWS`     | Deployment config files                                                |
   | `Node.js >=18`     | Runtime version from config                                            |
   | `Jira`             | Detected project management tool (GitHub, Jira, Azure, Linear, GitLab) |
   | `https://napx.atlassian.net`              | Project management URL (if applicable)                                 |
   | `NAPX`       | Project/workspace ID (if applicable)                                   |
   | `NAPX-###`        | Issue key format (e.g., PROJ-###, #42)                                 |
   | `TypeScript`            | Detected ecosystem (TypeScript, PHP, C#, Python, Ruby, Go, Rust, Java) |
   | `NestJS + Next.js`           | Detected framework with version                                        |
   | `pnpm`     | Detected package manager                                               |
   | `3000`            | Scripts, config, or framework defaults                                 |
   | `apps/`             | Source directory (src, app, lib, src/main, etc.)                       |
   | `apps/api/test/`            | Test directory (tests, test, spec, **tests**, src/test)                |
   | `ts`      | Primary file extension (ts, php, cs, py, rb, go, rs, java)             |
   | `PostgreSQL (Amazon RDS)`            | ORM/database library                                                   |
   | `Jest`      | Testing framework                                                      |
   | `AWS`     | Deployment config files                                                |
   | `Node.js >=18`     | Node, PHP, .NET, Python version from config                            |
...
7. **Recommend and Install AI Agent Skills**:
   ...
   **Present Skills Recommendation:**
   ...
   Based on your project (NestJS + Next.js/TypeScript), these skills will enhance your AI assistant:
...
9. **Report Completion**:
   ...
   📁 Updated Files:
   - AGENTS.md (with TypeScript/NestJS + Next.js patterns)
   - .github/copilot-instructions.md
...
10. **Review Installed Skills**:
    ...
    | {{FRAMEWORK_SKILL}} | NestJS + Next.js patterns | Matches framework |
